...
VPS and Nginx/PM2 + Turso/sqlite3 are alternative hosting options supported by parts of the codebase, but they are not the active production environment and are not part of this deployment procedure.
